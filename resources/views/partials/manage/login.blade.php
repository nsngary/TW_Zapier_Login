...
<head>
    ...
    <title>TW_Zapier 後端管理系統</title>

    {{-- Favicon --}}
    <link rel="shortcut icon" href="{{ asset('logo/fav.png') }}">
    <link rel="apple-touch-icon" sizes="144x144" href="{{ asset('logo/fav.png') }}">
    <link rel="apple-touch-icon" sizes="114x114" href="{{ asset('logo/fav.png') }}">
    <link rel="apple-touch-icon" sizes="72x72" href="{{ asset('logo/fav.png') }}">
    <link rel="apple-touch-icon" sizes="57x57" href="{{ asset('logo/fav.png') }}">
...
<body
    class="min-h-screen bg-gradient-to-br from-primary-500 via-primary-600 to-primary-700 flex items-center justify-center p-4">
    ...
    {{-- 登入卡片 --}}
    <div class="relative w-full max-w-md opacity-95">
        <div class="bg-white/95 backdrop-blur-sm rounded-2xl shadow-2xl p-8 border border-white/20">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-neutral-600">後端管理系統</p>
            </div>
            ...
            <form method="POST" action="{{ route('admin.login.post') }}" class="space-y-6">
                ...
                {{-- 登入按鈕 --}}
                <button type="submit"
                    class="w-full bg-primary-500 hover:bg-primary-600 text-white font-semibold py-3 px-4 rounded-lg transition-all duration-200 transform hover:scale-[1.02] focus:ring-2 focus:ring-primary-500 focus:ring-offset-2">
