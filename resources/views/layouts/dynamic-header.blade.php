...
<header
    ...
    <div class="flex items-center gap-4">
        <!-- Logo -->
        <a class="focus-visible:outline-2 focus-visible:outline-header-link-focus focus-visible:outline-offset-0.5"
            aria-label="TW Zapier" href="{{ $isAdminInterface ? route('admin.index') : '/' }}">
                            ...
                            <details data-testid="nav-dropdown" class="dropdown-container">
                                <summary class="dropdown-summary" data-testid="nav-dropdown-summary">
                                    ...
                                    <span class="dropdown-indicator">
                                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                            xmlns="http://www.w3.org/2000/svg" size="16" aria-hidden="false" role="img"
                                            data-name="arrowSmallDown">
                                            <path
                                                d="M12 17.2999L19 11.4399V8.81995L12 14.6999L5 8.81995V11.4399L12 17.2999Z"
                                    ...
                                    <div class="dropdown-main bg-header-dropdown-bg">
                                        <div class="dropdown-content">
                                            ...
                                            <div class="dropdown-sections">
                                                <div>
                                                    <div class="section-heading" id="products-submenu-heading-products">
                                                        Products</div>
                                                    <ul class="section-list"
                                                        ...
                                                        <li class="section-item">
                                                            <a class="section-link" href="/tables" aria-label="Tables">
                                                                <div class="section-icon bg-orange-50 text-primary-500">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg">
                                                                        <path d="M12 2.9978H21.0022V7.49897H12V2.9978Z"
                                                                            fill="currentColor"></path>
                                                                        <path
                                                        ...
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                ...
                                                <div>
                                                    <div class="section-heading" id="products-submenu-heading-capabilities">
                                                        Capabilities</div>
                                                    <ul class="section-list"
                                                        aria-labelledby="products-submenu-heading-capabilities">
                                                        <li class="section-item">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                aria-label="App integrations">
                                                                <div>
                                                        ...
                                                        <li class="section-item">
                                                            <a class="section-link" href="/ai"
                                                                aria-label="AI automation 🪄">
                                                                <div>
                                                                    <div class="section-label"><span>AI agents 自動化 🪄</span>
                                                                    </div>
                                                        ...
                                                        <li class="section-item">
                                                            <a class="section-link" href="/security-compliance"
                                                                aria-label="Security">
                                                                <div>
                                        ...
                                        <div>
                                            ...
                                            <ul class="section-list" aria-labelledby="products-submenu-heading-whats-new">
                                                    ...
                                                    <a class="section-link" href="/canvas" aria-label="Canvas">
                                                        <div class="section-icon text-neutral-700">
                                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                                ...
                                                                class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                aria-hidden="false" role="img" data-name="navAIChatbot"
                                                                data-block="false" data-pointer-events="true"
                                                                data-animate-fill="true" style="--color:inherit">
                                                                <path d="M6.99999 2H2V6.99999H6.99999V2Z"
                                                                    fill="currentColor"></path>
                                                                <path d="M21.9997 12H2.00049V17H21.9997V12Z"
                                                                    fill="currentColor"></path>
                                                                <path
                                                                    d="M21.9997 12L7 12L6.99999 6.99999L12 7V2H22L21.9997 12Z"
                                                                    fill="currentColor">
                                                                </path>
                                                                <path d="M6.99951 22V17H11.9995L6.99951 22Z"
                                                                    fill="currentColor"></path>
                                                            </svg>
                                                        </div>
                                                        <div>
                                                    ...
                                                    <a class="section-link" href="/canvas" aria-label="Canvas">
                                                        <div class="section-icon text-neutral-700">
                                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg" size="20"
                                                                class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                aria-hidden="false" role="img" data-name="navCentral"
                                                                data-block="false" data-pointer-events="true"
                                                                data-animate-fill="true" style="--color:inherit">
                                                                <g clip-path="url(#clip0_36933_10681)">
                                                                    ...
                                                                    <rect x="16.5" y="3" width="4.5" height="4.5"
                                                                        fill="currentColor"></rect>
                                                                    <rect x="16.5" y="16.5001" width="4.5" height="4.5"
                                                                        fill="currentColor"></rect>
                                                                    <rect x="3" y="16.5001" width="4.5" height="4.5"
                                                                        fill="currentColor"></rect>
                                                                    <rect x="7.50049" y="7.49988" width="9" height="9"
                                                                        fill="currentColor"></rect>
                                                                </g>
                                                                <defs>
                                                    ...
                                                    <a class="section-link" href="/canvas" aria-label="Canvas">
                                                        <div class="section-icon text-neutral-700">
                                                            <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                                                xmlns="http://www.w3.org/2000/svg" size="20"
                                                                class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                aria-hidden="false" role="img" data-name="navFunctions"
                                                                data-block="false" data-pointer-events="true"
                                                                data-animate-fill="true" style="--color:inherit">
                                                                <path
                                                ...
                                                <li class="section-item">
                                                    <a class="section-link" href="/canvas" aria-label="Canvas">
                                                        <div class="section-icon text-neutral-700">
                                                            <img src="https://res.cloudinary.com/zapier-media/image/upload/v1743546142/mcp_retev0.svg"
                                                                alt="MCP-logo" loading="lazy" width="20" height="20">
                                                        </div>
                                                        <div>
                                                            <div class="section-label">
                                                                <span>MCP</span>
                        ...
                        <li>
                            <details data-testid="nav-dropdown" class="dropdown-container">
                                ...
                                <div class="dropdown-panel">
                                    <div class="dropdown-main bg-header-dropdown-bg">
                                        <div class="dropdown-content">
                                            <div class="dropdown-header">
                                                ...
                                                <p class="dropdown-description">Zapier 如何幫助您實現工作的自動化</p>
                                            </div>
                                            <div class="dropdown-sections">
                                                <div>
                                                    <div class="section-heading" id="products-submenu-heading-products">BY
                                                        TEAM</div>
                                                    <ul class="section-list"
                                                        aria-labelledby="products-submenu-heading-products">
                                                        <li class="section-item">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        fill="none" xmlns="http://www.w3.org/2000/svg"
                                                                        size="20"
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img"
                                                                        data-name="miscWalletFill" data-block="false"
                                                                        data-pointer-events="true" data-animate-fill="true"
                                                                        style="--color:inherit;"
                                                                        data-v-inspector="components/layout/HeaderNavigation.vue:346:54"
                                                                        data-v-a752518b="">
                                                                        <path
                                                                            ...
                                                                            fill="currentColor"
                                                                            data-v-inspector="components/layout/HeaderNavigation.vue:351:37"
                                                                            data-v-a752518b=""></path>
                                                                    </svg>
                                                                </div>
                                                                <div>
                                                                    <div class="section-label"><span>RevOps</span></div>
                                                                    <div class="section-desc">透過自動化增加收入</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/tables" aria-label="Tables">
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        ...
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img"
                                                                        data-name="miscColorFill" data-block="false"
                                                                        data-pointer-events="true" data-animate-fill="true"
                                                                        style="--color:inherit">
                                                                        <path
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="section-desc">提高行銷效果與投報綠</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                                ...
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        ...
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img"
                                                                        data-name="navCogFill" data-block="false"
                                                                        data-pointer-events="true" data-animate-fill="true"
                                                                        style="--color:inherit">
                                                                        <path
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="section-desc">提升 IT 系統管理效率</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                                ...
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        ...
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img"
                                                                        data-name="personSettings" data-block="false"
                                                                        data-pointer-events="true" data-animate-fill="true"
                                                                        style="--color:inherit">
                                                                        <path
                                                                ...
                                                                <div>
                                                                    <div class="section-label"><span>HR</span></div>
                                                                    <div class="section-desc">利用 AI 自動化增強人力資源團隊</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                                ...
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        ...
                                                                        size="20"
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img" data-name="miscGraph"
                                                                        data-block="false" data-pointer-events="true"
                                                                        data-animate-fill="true" style="--color:inherit">
                                                                        <path d="M13.5 4H10.5V20H13.5V4Z"
                                                                            fill="currentColor"></path>
                                                                        <path d="M7.5 12H4.5V20H7.5V12Z"
                                                                            fill="currentColor"></path>
                                                                        <path d="M19.5 9H16.5V20H19.5V9Z"
                                                                            fill="currentColor"></path>
                                                                    </svg>
                                                                </div>
                                                                <div>
                                                                    <div class="section-label"><span>銷售</span></div>
                                                                    <div class="section-desc">達成更多交易量</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                                ...
                                                                <div class="section-icon bg-purple-50 text-purple">
                                                                    <svg width="20" height="20" viewBox="0 0 24 24"
                                                                        ...
                                                                        class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                        aria-hidden="false" role="img"
                                                                        data-name="miscHeadsetFill" data-block="false"
                                                                        data-pointer-events="true" data-animate-fill="true"
                                                                        style="--color:inherit">
                                                                        <path
                                                                ...
                                                                <div>
                                                                    <div class="section-label"><span>客服</span></div>
                                                                    <div class="section-desc">提升客服效率</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/interfaces"
                                                                ...
                                                                <div>
                                                                    <div class="section-label"><span>決策者</span></div>
                                                                    <div class="section-desc">簡化決策流程</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div>
                                                    ...
                                                    <ul class="section-list"
                                                        aria-labelledby="products-submenu-heading-capabilities">
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                aria-label="App integrations">
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1729015353/site-layout/header/app-icons/netsuitelogo_osrxfh.png"
                                                                            alt="Netsuite icon" loading="lazy" width="20"
                                                                            height="20">
                                                                        <span>Netsuite</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147606/site-layout/header/app-icons/salesforce_kebpl5.png"
                                                                            alt="Salesforce icon" loading="lazy" width="20"
                                                                            height="20">
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147605/site-layout/header/app-icons/hubspot_otfufb.png"
                                                                            alt="HubSpot icon" loading="lazy" width="20"
                                                                            height="20">
                                                                        <span>HubSpot</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147607/site-layout/header/app-icons/slack_xrar0o.png"
                                                                            alt="Slack icon" loading="lazy" width="20"
                                                                            height="20">
                                                                        <span>Slack</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147606/site-layout/header/app-icons/openai_xxgknd.png"
                                                                            alt="OpenAI icon" loading="lazy" width="20"
                                                                            height="20">
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147606/site-layout/header/app-icons/microsoft-dynamics_hxfa1t.png"
                                                                            alt="Microsoft Dynamics CRM icon" loading="lazy"
                                                                            width="20" height="20">
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147606/site-layout/header/app-icons/microsoft-teams_reemfd.png"
                                                                            alt="Microsoft Teams icon" loading="lazy"
                                                                            width="20" height="20">
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147607/site-layout/header/app-icons/zendesk_llbzm0.png"
                                                                            alt="Zendesk icon" loading="lazy" width="20"
                                                                            height="20">
                                                                        <span>Zendesk</span>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <li class="section-item mb-2">
                                                            <a class="section-link" href="{{ route('user.apps.index') }}"
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <img src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1726147605/site-layout/header/app-icons/jira_wzv3pe.png"
                                                                            alt="Jira icon" loading="lazy" width="20"
                                                                            height="20">
                                                                ...
                                                                <div class="grid">
                                                                    <div class="section-label">
                                                                        <svg width="20" height="20" viewBox="0 0 24 24"
                                                                            ...
                                                                            class="zapier-zinnia-icons__icon__8f1EW1A1"
                                                                            aria-hidden="false" role="img"
                                                                            data-name="navApps" data-block="false"
                                                                            ...
                                                                            <path d="M13 21H21V13H13V21ZM15 15H19V19H15V15Z"
                                                                                fill="currentColor"></path>
                                                                            <path d="M18 6V3H16V6H13V8H16V11H18V8H21V6H18Z"
                                                                                fill="currentColor"></path>
                                                                        </svg>
                                                                        <span>查看所有應用程式</span>
                                                                    </div>
                                                ...
                                                <div>
                                                    ...
                                                    <ul class="section-list"
                                                        aria-labelledby="products-submenu-heading-products">
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>潛在客戶管理</span></div>
                                                                    <div class="section-desc">提升轉換率</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    ...
                                                                    <div class="section-desc">簡化廠商對接、客戶談話</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>行銷活動</span></div>
                                                                    <div class="section-desc">提升行銷活動效果和 ROI</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>客戶支援</span></div>
                                                                    <div class="section-desc">快速發送驗證與回覆</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>資料管理</span></div>
                                                                    <div class="section-desc">串聯資料庫以獲得有效資訊</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>專案管理</span></div>
                                                                    <div class="section-desc">無縫交接項目</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item mb-1">
                                                            <a class="section-link" href="/workflows" aria-label="Zaps">
                                                                <div>
                                                                    <div class="section-label"><span>罰單與事故</span></div>
                                                                    <div class="section-desc">更快地解決問題與突發事件</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                    ...
                                    <aside class="dropdown-aside">
                                        <div>
                                            <a class="section-link flex mb-5" href="/workflows" aria-label="Zaps">
                                                <div class="">
                                                    <img class="SubmenuArticle-module_image_8e3JR3cL"
                                                        src="https://res.cloudinary.com/zapier-media/image/upload/f_auto/q_auto/v1716910976/Global_Nav_April_2024_aeaycw.png"
                                                        alt="Graphic that shows automation icons connected to a central hub"
                                                        loading="lazy" width="96">
                                                </div>
                                                <div class="justify-center">
                                                    <div class="section-label"><span>RevOps123</span></div>
                                                    <div class="section-desc">透過自動化增加收入</div>
                                                </div>
                                            </a>
                                            <div class="section-heading">ZAPIER FOR</div>
                                            <ul class="section-list">
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">新創企業</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">中小型企業</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">上市企業</div>
                                                    </a>
                                                </li>
                            ...
                            <details data-testid="nav-dropdown" class="dropdown-container">
                                ...
                                <div class="dropdown-panel">
                                    <div class="dropdown-main bg-header-dropdown-bg">
                                        <div class="dropdown-content">
                                            <div class="dropdown-header">
                                                <div class="dropdown-heading">學習資源</div>
                                                <p class="dropdown-description">了解如何使用 Taipier 流程自動化平台，提升您的工作效率</p>
                                            </div>
                                            <div class="dropdown-sections">
                                                <div>
                                                    <div class="section-heading">靈感</div>
                                                    <ul class="section-list">
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>5 個理由</span></div>
                                                                    <div class="section-desc">節省時間的熱門工作流程</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>建立自訂聊天機器人</span></div>
                                                                    <div class="section-desc">幾分鐘內就建造一個 AI 聊天機器人</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Webhook 和 Zapier</span>
                                                                    </div>
                                                                    <div class="section-desc">使用 Webhook 連接您喜愛的應用程式</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>客戶案例</span></div>
                                                                    <div class="section-desc">了解 Zapier 能如何幫助企業成長</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    ...
                                                                    <div class="section-desc">閱讀有關應用程式和自動化的文章</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>指南</span></div>
                                                                    <div class="section-desc">深入探討專門指導</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div>
                                                    <div class="section-heading">學習使用 ZAPIER</div>
                                                    <ul class="section-list">
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Zapier 基礎知識</span>
                                                                    </div>
                                                                    <div class="section-desc">創建第一個 Zapier</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>產品導覽</span>
                                                                    </div>
                                                                    <div class="section-desc">到 Zapier 工作區一探究竟</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Zapier 101</span>
                                                                    </div>
                                                                    <div class="section-desc">透過我們的研討會，深入了解 Zapier</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>活動與直播</span>
                                                                    </div>
                                                                    <div class="section-desc">參加即時或觀看錄製的活動</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Zapier 學習</span>
                                                                    </div>
                                                                    <div class="section-desc">線上課程，按照自己的步調學習</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
                                                ...
                                                <div>
                                                    <div class="section-heading">獲得協助</div>
                                                    <ul class="section-list">
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>幫助中心</span></div>
                                                                    <div class="section-desc">找到問題的答案</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>聘請 Zapier 解決方案合作夥伴</span></div>
                                                                    <div class="section-desc">尋找顧問來幫助您做更多</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Zapier 社群</span></div>
                                                                    <div class="section-desc">與其他 Zapier 用戶交流</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>支援服務</span></div>
                                                                    <div class="section-desc">為您的自動化之旅提供支持</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                        <li class="section-item">
                                                            <a class="section-link" href="/learn" aria-label="Learn">
                                                                <div>
                                                                    <div class="section-label"><span>Zapier 支持</span></div>
                                                                    <div class="section-desc">取得適合各種預算的協助和研究支援選項</div>
                                                                </div>
                                                            </a>
                                                        </li>
                                                    </ul>
                                    ...
                                    <aside class="dropdown-aside">
                                        <div>
                                            <a class="section-link flex mb-5" href="/workflows" aria-label="Zaps">
                                                ...
                                                <div>
                                                    <div class="section-label"><span>Zapier 快速入門指南</span></div>
                                                    <div class="section-desc">輕鬆建立你的第一個 ZAP</div>
                                                </div>
                                            </a>
                                            <div class="section-heading">開發者資源</div>
                                            <ul class="section-list">
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">由 Zapier 提供支持</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">建構整合</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">嵌入集合</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                                        <div class="section-label">整合夥伴計劃</div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a class="section-link flex" href="/workflows" aria-label="Zaps">
                                            ...
                                            <ul class="section-list">
                                                <li class="section-item">
                                                    <a class="section-link"
                                                        href="{{ route('admin.edit', $currentUser->account) }}">
            ...
            <div class="hidden desktop:block">
                <nav aria-label="Secondary site navigation">
                    <ul class="flex items-center gap-1 list-none">
                        ...
                        <li>
                            <a class="nav-link" href="{{ route('user.cart.index') }}" aria-label="心願清單">
                                <span class="flex">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                ...
                <summary class="mobile-nav-summary" aria-label="Menu" data-testid="mobile-nav-summary">
                    <span class="mobile-nav-open">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            size="24" aria-hidden="false" role="img" data-name="navMenu">
                    ...
                    <span class="mobile-nav-close">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                            size="24" aria-hidden="false" role="img" data-name="formX">
                            <path
                        ...
                        <nav>
                            <ul class="mobile-nav-list">
                                @if($isAdminInterface)
                                    ...
                                    @endif
                                    @if($isAdmin && in_array('s00', $permissions))
                                        <li><a href="{{ route('admin.permissions.index') }}" class="mobile-nav-link">權限管理</a>
                                        </li>
                                    @endif
                                    @if($isAdmin && (in_array('s02', $permissions) || in_array('s03', $permissions)))
